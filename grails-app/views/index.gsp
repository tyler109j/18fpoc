        ...
        <div class="container-fluid">
            ...
            <div style="margin-bottom:5px; padding-bottom:5px;padding-top:5px; margin-top:10px;">
                ...
                <td style="background-color:#489aee">
                    <p><h2 style="color:#ffffff">Food Recall Locator</h2></p>
                </td>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 " style="position: relative;">
                    <div>
                        <div id="map"  style="width:100%;margin: 0 auto">
                        </div>
                    </div>
                    <div>
...
<footer class="footer">
      <div class="container">
        <p class="text-muted"  style="color:white; margin-left: 25%">This website uses data provided by <a style="color:white" href="http://open.fda.gov">open.fda.gov.</a></p>
      </div>
    </footer>
</body>
</html>
